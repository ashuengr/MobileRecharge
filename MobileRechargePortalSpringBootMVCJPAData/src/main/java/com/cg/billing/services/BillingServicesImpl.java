...
public class BillingServicesImpl implements BillingServices{
    ...
    @Autowired
	PostpaidAccountDaoServices postpaidAccountDao;
	@Autowired
	BillDaoServices billDao;
	@Override
	...
	public long openPostpaidMobileAccount(int customerID, int planID)
		...
		Plan plan=planDao.findById(planID).orElseThrow(()->new PlanDetailsNotFoundException("Plan does not exist"));
	...
	public PostpaidAccount getPostPaidAccountDetails(int customerID, long mobileNo)
		...
		postpaidAccount= postpaidAccountDao.findById(customerID).orElseThrow(()->new PostpaidAccountNotFoundException("Postpaid Account not found"));
	...
	public Bill getMobileBillDetails(int customerID, long mobileNo, String billMonth)
		...
		if(billMonth.equalsIgnoreCase("January")||billMonth.equalsIgnoreCase("February")||billMonth.equalsIgnoreCase("march")||billMonth.equalsIgnoreCase("april")||billMonth.equalsIgnoreCase("June")||billMonth.equalsIgnoreCase("may")||
		   billMonth.equalsIgnoreCase("July")||billMonth.equalsIgnoreCase("august")||billMonth.equalsIgnoreCase("september")||billMonth.equalsIgnoreCase("october")||billMonth.equalsIgnoreCase("november")||billMonth.equalsIgnoreCase("december"))
		    bill= billDao.getMonthlyMobileBill(mobileNo,billMonth);
		else
	...
	public boolean changePlan(int customerID, long mobileNo, int planID)
		...
		PostpaidAccount postpaidAccount=getPostPaidAccountDetails(customerID, mobileNo);
		Plan plan=planDao.findById(planID).orElseThrow(()->new PlanDetailsNotFoundException("No such plan available"));
